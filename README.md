# Available .EVENTS One-Word Domains (8,055)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C056%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-8%2C055%20domains-6f42c1">
  <img alt="formats" src="https://img.shields.io/badge/formats-CSV%20%7C%20JSON-f59e0b">
  <img alt="license" src="https://img.shields.io/badge/license-see%20LICENSE-6b7280">
</p>

Daily-updated dataset of available and resale .events one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 8,056 rows · **Live catalog:** 8,055 domains
...
- `events.csv` — public CSV extract (8,056 rows)
- `events.json` — public JSON extract (8,056 rows)
...
| ------------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ---------------- |
| silver.events       | available | $57.98    | —             | 56             | 99     | 6      | namecheap        |
| entrepreneur.events | resell    | —         | —             | 78             | 80     | 12     | GoDaddy.com, LLC |
| zero.events         | premium   | $82.50    | $82.50        | 112            | 54     | 4      | name.com         |
| cozy.events         | available | $21.99    | $56.99        | 110            | 37     | 4      | name.com         |
| hello.events        | resell    | —         | —             | 130            | 71     | 5      | Sav.com, LLC     |
| abc.events          | premium   | $85.80    | $85.80        | 102            | 50     | 3      | namecheap        |
| sharp.events        | available | $21.99    | $56.99        | 84             | 36     | 5      | name.com         |
| now.events          | resell    | —         | —             | 78             | 66     | 3      | GoDaddy.com, LLC |
| food.events         | premium   | $520      | $520          | 94             | 44     | 4      | namecheap        |
| goon.events         | available | $21.99    | $56.99        | 80             | 36     | 5      | name.com         |
...
| research.events     | premium   | $128.70   | $128.70       | 92             | 41     | 8      | namecheap        |
...
| ----------------------- | ------------------------------------------------ |
| 8,056-row public sample | 8,055 live domains                               |
...
> Unique Domains. *Available .EVENTS One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
